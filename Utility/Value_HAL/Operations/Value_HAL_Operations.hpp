...
SSource
{
	...
	sfn GreaterOrEqual(ro ptr<ro AValue_HAL> Subject, ro ptr<ro AValue_HAL> Reference) -> bool;
	sfn LessOrEqual   (ro ptr<ro AValue_HAL> Subject, ro ptr<ro AValue_HAL> Reference) -> bool;
	...
	sfn Divide_Integer(ro ptr<AValue_HAL> Subject, ro ptr<ro AValue_HAL> Reference) -> void;

	sfn Modulo(ro ptr<AValue_HAL> Subject, ro ptr<ro AValue_HAL> Reference) -> void;
}
